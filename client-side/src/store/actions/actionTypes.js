...
export const RECHARGE_ACCOUNT_START = "RECHARGE_ACCOUNT_START";
export const RECHARGE_ACCOUNT_SUCCESS = "RECHARGE_ACCOUNT_SUCCESS";
export const RECHARGE_ACCOUNT_FAIL = "RECHARGE_ACCOUNT_FAIL";

export const CLEAR_UNAUTHORIZED_STATE = "CLEAR_UNAUTHORIZED_STATE";